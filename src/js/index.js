const filmsUrlSort = `http://127.0.0.1:8000/api/v1/titles/?sort_by=-imdb_score&`
const filmsMainUrl= `http://127.0.0.1:8000/api/v1/titles/`
 ...
 */
const FilmsUrlWithGenre = function(url, genre){
 ...
 *  top rated films  
 */
const genre = "good-films"
AddFilmToGenre(filmsUrlSort, genre)
